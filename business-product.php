                ...
                <div class="row justify-content-lg-center card p-3">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="account-tab" data-bs-toggle="tab" data-bs-target="#account" type="button" role="tab" aria-controls="account" aria-selected="true">View Business Product</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="scurity-tab" data-bs-toggle="tab" data-bs-target="#scurity" type="button" role="tab" aria-controls="scurity" aria-selected="false">Add Business Product</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">                            
                            <div class="col-lg-12">
                                <br/><h1 class="page-header-title">Business Product</h1><br/>
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="catTable">
                                        ...
                                        $cu = $conn->link->query("SELECT * FROM `tb_business_product` where bp_ub_id=" . $cu_re['ub_id']);
                                ...
                                <form method="post" action="./custom/rest/request.php" enctype="multipart/form-data">                                        
                                    ...
                                    <div class="row">     
                                        <div class="col-sm-6 mt-2">
                                            <label for="bp_name" class="form-label">Product Name</label>
                                            <input type="text" class="form-control" id="bp_name" name="bp_name">                                            
                                        </div> 
                                        <div class="col-sm-6"></div>
                                        <div class="col-sm-6 mt-2">
                                            <label for="bp_description" class="form-label">Product Description</label>
                                            <input type="text" required class="form-control" id="bp_description" name="bp_description">
                                        </div>
                                        <div class="col-sm-6 mt-2">
                                            <label for="bp_price" class="form-label">Product Price</label>
                                            <input type="text" required class="form-control" id="bp_price" name="bp_price">
                                        </div>
                                    </div><br/>
                                    <div class="row">    
                                        <div class="col-sm-4 text-center">
                                            ...
                                            <button type="button" class="btn btn-primary btn-xs" onclick="document.getElementById('fileInput').click();">Upload Product photo</button>
                                            <button type="button" class="btn btn-danger btn-xs" onclick="resetFileInput()">Reset</button>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end gap-3">                                
                                        <button type="submit" class="btn btn-primary btn-sm" name="business_product_save" id="business_product_save" value="business_product_save">Save Changes</button>
                                        <button type="reset" class="btn btn-primary btn-sm"  name="business_product_reset" id="business_product_reset" value="business_product_reset">Reset</button>
                                    </div>
                                </form>                                              
                            </div>
                        </div>
                    </div>
                    <div class="col-sm mt-2 text-end">
