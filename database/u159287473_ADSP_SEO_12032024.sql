...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2024 at 05:04 PM
...
CREATE TABLE `tb_buisness_category` (
  `bca_id` int(11) NOT NULL,
...
CREATE TABLE `tb_buisness_cities` (
...
CREATE TABLE `tb_business_details` (
  ...
  `bd_meta_description` text DEFAULT NULL,
...
(1, 'https://hailey.com/', 'ADVOCATE', 'Top 10 Advocates in - Best Advocates in .', 'Best Advocates in , Best Civil Lawyers in ,  Best Advocates in , Best Attorneys Lawyers For High Court in , Lawyers For Property Case in .', 'Civil Lawyers, Advocates, Solicitors, Attorneys, Lawyers For High Court, Lawyers For Property Case, Lawyers For Divorce Case, Lawyers For High Court, Family Case Lawyers, Lawyers For Matrimonial Cases, Tax Lawyers in . Get Phone Numbers, Address, Reviews, Photos, Maps for Advocates in on ShopeeMart.', NULL, 'a');
...
INSERT INTO `tb_user_login` (`ul_id`, `ul_firstname`, `ul_surname`, `ul_telephone`, `ul_mail`, `ul_username`, `ul_password`, `ul_occupation`, `ul_language`, `ul_status`) VALUES
(1, 'user', 'user', '9876543210', 'user@gmail.com', 'root', 'c42ed237ae635a4da5315bfba2cabc6e57cb1eae48f9942e33433324b77d06ec1556f73d69e57543b4da2fae52800b341813b80ad2bd0243e4038781efe489a2', 'occupation', 'en', 'a');
...
--
-- Indexes for table `tb_buisness_category`
--
ALTER TABLE `tb_buisness_category`
  ADD PRIMARY KEY (`bca_id`);

--
-- Indexes for table `tb_buisness_cities`
--
ALTER TABLE `tb_buisness_cities`
  ADD PRIMARY KEY (`bc_id`);

--
-- Indexes for table `tb_business_details`
--
ALTER TABLE `tb_business_details`
...
--
-- AUTO_INCREMENT for table `tb_buisness_category`
--
ALTER TABLE `tb_buisness_category`
  MODIFY `bca_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tb_buisness_cities`
--
ALTER TABLE `tb_buisness_cities`
  MODIFY `bc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_business_details`
--
ALTER TABLE `tb_business_details`
...
--
ALTER TABLE `tb_user_login`
  MODIFY `ul_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
