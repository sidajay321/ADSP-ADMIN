                ...
                <div class="row justify-content-lg-center card p-3">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="account-tab" data-bs-toggle="tab" data-bs-target="#account" type="button" role="tab" aria-controls="account" aria-selected="true">Business Hours</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">                            
                            ...
                            ?>
                            <div class="col-lg-12">
                                <br/><h1 class="page-header-title">My Business Hours</h1><br/>
                                <form method="post" action="./custom/rest/request.php">                                        
                                    ...
                                    <div class="d-flex justify-content-end gap-3">                                
                                        <button type="submit" class="btn btn-primary btn-sm" name="user_hour_save" id="user_hour_save" value="user_hour_save">Save Changes</button>
                                        <button type="reset" class="btn btn-primary btn-sm"  name="user_hour_reset" id="user_hour_reset" value="user_hour_reset">Reset</button>
                                    </div>
                                </form>                                              
                            </div>
                        </div>
