        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item dropdown active">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#">&#x203A; License</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:void();">&#x203A; Add new customer</a></li>                               
                            </ul>
                        </li>
                        <li class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#">&#x203A; Users management</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:void();">&#x203A; Add new customer</a></li>                                
                                <li><a class="dropdown-item" href="javascript:void();">&#x203A; Users management</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#">&#x203A; Warehouse management</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:void();">&#x203A; Manage the warehouse</a></li>                                                                
                            </ul>
                        </li>
                        <li><a class="dropdown-item" href="#">&#x203A; Units & tax administration</a></li>
                        <li><a class="dropdown-item" href="#">&#x203A; Issuance of products</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li><a class="dropdown-item" href="./add-product-information.php">&#x203A; Add new product</a></li>
                        <li><a class="dropdown-item" href="./product-category.php">&#x203A; Product category management</a></li>
                        <li><a class="dropdown-item" href="./view-product-information.php">&#x203A; View database</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">                                        
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="./stockpilling.php">&#x203A; Create new order</a></li>
                                <li><a class="dropdown-item" href="./view-stockpilling.php">&#x203A; View orders</a></li>
                            </ul>
                        </li>
                        <li><a class="dropdown-item" href="./receiving_incoming_goods.php">&#x203A; Arrival at the warehouse</a></li>
                        <li class="dropdown-submenu">
